...
extension BrewService {
    ...
    func setupDataAndHandlers(
        ...
        setupTerminationHandler(for: process, outputData: outputData, errorData: errorData, continuation: continuation)
    }
    ...
    func handleProcessTermination(
        ...
        if process.terminationStatus != 0 {
            ...
            if let output = String(data: outputData as Data, encoding: .utf8) {
                ...
                self.finishProcess(process: process, continuation: continuation, error: BrewError.parsingError)
            }
        }
    }
    ...
    func executeProcess(
        ...
        do {
            ...
            if (error as NSError).code == 1 || (error as NSError).code == 5 {
                ...
                continuation.resume(throwing: BrewError.commandFailed("Launch failed: \(error.localizedDescription)"))
            }
        }
    }
}
