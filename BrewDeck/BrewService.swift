...
enum BrewError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .brewNotFound: "Homebrew not found. Please ensure it is installed."
        case let .commandFailed(detail): detail
        case .parsingError: "Failed to parse Homebrew output."
        case .timeout: "The Homebrew command timed out."
        case .permissionDenied:
            "Permission Denied (OS 0x5). "
